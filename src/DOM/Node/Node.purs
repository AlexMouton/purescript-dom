...
nodeType = U.fromJust <<< toEnum <<< nodeTypeIndex
...
foreign import ownerDocument :: forall eff. Node -> Eff (dom :: DOM | eff) (Nullable Document)

-- | The parent node of the node.
foreign import parentNode :: forall eff. Node -> Eff (dom :: DOM | eff) (Nullable Node)

-- | The parent element of the node.
foreign import parentElement :: forall eff. Node -> Eff (dom :: DOM | eff) (Nullable Element)
...
foreign import firstChild :: forall eff. Node -> Eff (dom :: DOM | eff) (Nullable Node)

-- | The last child of the node, or null if the node has no children.
foreign import lastChild :: forall eff. Node -> Eff (dom :: DOM | eff) (Nullable Node)

-- | The previous sibling node, or null if there is no previous sibling.
foreign import previousSibling :: forall eff. Node -> Eff (dom :: DOM | eff) (Nullable Node)

-- | The next sibling node, or null if there is no next sibling.
foreign import nextSibling :: forall eff. Node -> Eff (dom :: DOM | eff) (Nullable Node)
...
foreign import lookupPrefix :: forall eff. String -> Node -> Eff (dom :: DOM | eff) (Nullable String)
foreign import lookupNamespaceURI :: forall eff. String -> Node -> Eff (dom :: DOM | eff) (Nullable String)
